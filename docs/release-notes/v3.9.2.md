...
`ghcr.io/CoderNemesis26/corescope:v3.9.2` (multi-arch: amd64, arm64)
...
```
/container add remote-image=ghcr.io/CoderNemesis26/corescope:v3.9.2 envlist=cs-env mounts=cs-data,cs-caddyfile interface=veth-corescope start-on-boot=yes name=corescope-prod-v392
```
